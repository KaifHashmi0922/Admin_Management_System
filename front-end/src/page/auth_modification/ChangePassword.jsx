...
export default function ChangePassword() {
  ...
  const isDisabled = loading || !formData.password || !formData.confirm_password;
          ...
          <div className="text-center space-y-4 pt-4">
            ...
            <div>
              <h1 className="text-3xl lg:text-4xl font-black text-slate-900 mb-2 bg-gradient-to-r from-slate-900 to-slate-800 bg-clip-text">
                Update Password<span className="text-blue-600"> 🔐</span>
              </h1>
          ...
          <form className="space-y-6" onSubmit={HandleSubmit}>
            ...
            <div className="flex gap-4">
              <Button
                type="button"
                onClick={Cancel}
                className="flex-1 py-4 rounded-2xl border border-slate-200/50 bg-white/90 backdrop-blur-sm text-slate-800 font-bold hover:bg-slate-50 hover:border-slate-300 hover:shadow-xl hover:shadow-slate-100/50 hover:-translate-y-0.5 transition-all duration-300 shadow-lg active:scale-98"
              >
                Cancel
              </Button>
            </div>
